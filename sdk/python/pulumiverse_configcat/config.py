...
class Config(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        my_config = configcat.Config("myConfig",
        ...
        * [Delete Config](https://api.configcat.com/docs/#tag/Configs/operation/delete-config)
        ...
        ```sh
        $ pulumi import configcat:index/config:Config example 08d86d63-2726-47cd-8bfc-59608ecb91e2
        ```
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            product_id: Optional[pulumi.Input[str]] = None) -> 'Config':
        """
