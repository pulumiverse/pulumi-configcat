...
namespace Pulumiverse.Configcat
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "api://github.com/pulumiverse";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Configcat.version.txt");
    ...
    internal sealed class ConfigcatResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ConfigcatResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
