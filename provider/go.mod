module github.com/pulumiverse/pulumi-configcat/provider/v5
...
require (
	github.com/configcat/terraform-provider-configcat/v5 v5.5.7
...
require (
	...
	github.com/configcat/configcat-publicapi-go-client/v2 v2.1.2 // indirect
